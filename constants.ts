...
export const VEO_PRESETS = {
  dolly_in: {
    ...
    prompt: "FRAME 0 INSTANT START: The video starts instantly on frame 0 with a stable real-world interior view. Absolutely zero intro transitions, zero page turns, zero paper flips, zero wipes, zero opening effects. The wallpaper is permanently attached flat to the solid architectural wall with zero peeling, zero corner curl, zero sheet bending, zero detachment, and zero paper lifting. An extremely slow, steady, and smooth cinematic camera push-in while gently panning and sliding sideways showing the room and wallpaper mural. The camera tracks diagonally across the room, focusing on showing the wallpaper pattern. The wallpaper behaves strictly as a static flat print on the wall with zero changes, zero morphing, and no new details appearing. All design elements on the wallpaper, including the arches, moon, and stars, are completely static and fixed, and do not move, shift, double, or animate. Every object, toy, and piece of furniture in the room stays perfectly still and fixed in its exact position — nothing sways, swings, dangles, or moves in any way. The view stays completely clear and unobstructed throughout the entire shot — nothing ever enters the frame, crosses in front of the camera, or blocks the view. High-end catalog style."
  },
  ambient: {
    label: "Легкое оживление / Живое фото (Ambient)",
    prompt: "FRAME 0 INSTANT START: The video starts instantly on frame 0 with a stable real-world interior view. Absolutely zero intro transitions, zero page turns, zero paper flips, zero wipes, zero opening effects. The wallpaper is permanently attached flat to the solid architectural wall with zero peeling, zero corner curl, zero sheet bending, zero detachment, and zero paper lifting. A static cinematic shot with a very slow, subtle horizontal camera drift (panning gently left-to-right). The only motion in the entire frame is a subtle, gentle shift in daylight and soft shadow across the room. Every object, toy, decoration, and piece of furniture stays perfectly still and fixed in its exact position — nothing sways, swings, dangles, spins, or moves in any way. No curtains, drapes, or fabric of any kind are present unless they were already clearly visible in the original photo, and even then they do not move. The wallpaper design on the back wall remains perfectly static, flat, and unchanged. All design elements on the wallpaper, including the arches, moon, and stars, are completely static and fixed, and do not move, shift, double, or animate. The view stays completely clear and unobstructed throughout the entire shot — nothing ever enters the frame, crosses in front of the camera, or blocks the view. High-end lifestyle catalog style."
  },
  dolly_out: {
    label: "Плавный отъезд камеры (Dolly-Out)",
    prompt: "FRAME 0 INSTANT START: The video starts instantly on frame 0 with a stable real-world interior view. Absolutely zero intro transitions, zero page turns, zero paper flips, zero wipes, zero opening effects. The wallpaper is permanently attached flat to the solid architectural wall with zero peeling, zero corner curl, zero sheet bending, zero detachment, and zero paper lifting. An extremely slow, steady, and smooth cinematic camera pull-back while gently tracking sideways to show the room and the full width of the wallpaper mural. The camera moves backward and slides horizontally. The wallpaper design remains a flat, non-moving print on the wall with zero morphing or details changing. All design elements on the wallpaper, including the arches, moon, and stars, are completely static and fixed, and do not move, shift, double, or animate. Every object, toy, and piece of furniture in the room stays perfectly still and fixed in its exact position — nothing sways, swings, dangles, or moves in any way. The view stays completely clear and unobstructed throughout the entire shot — nothing ever enters the frame, crosses in front of the camera, or blocks the view. High quality."
  }
};
